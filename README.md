...
**Django** starter styled with **[Material Dashboard PRO](https://appseed.us/product/material-dashboard-pro/django/)**, a premium `Bootstrap` Design from `Creative-Tim`.
...
- 👉 [Django Material PRO](https://django-material-dash-pro.onrender.com/) - `LIVE Demo`
...
> **Step 1** - Download the [code](https://appseed.us/product/material-dashboard-pro/django/) and unzip the sources (requires a `purchase`). 
...
> - Download the [code](https://appseed.us/product/material-dashboard-pro/django/) and unzip the sources (requires a `purchase`). 
...
---
[Django Material PRO](https://appseed.us/product/material-dashboard-pro/django/) - Starter crafted by **[AppSeed](https://appseed.us/)**.
